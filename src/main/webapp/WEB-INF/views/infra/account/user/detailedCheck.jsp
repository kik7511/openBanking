      ...
      <div class="row" style="padding: 10px 0;border-bottom: 0.5px solid; border-color:lightgray;">
       ...
       <div class="row" style="margin-bottom:20px; border-bottom: 0.5px solid; border-color:lightgray;">
            <div class="col"> 
	       		...
	       		<br>
	       		<lable>사용금액</lable>
	       		<input type="text" value="2,305,100원" style="border-style: none; width:300px; background: none;">
            </div>
        </div>
       <div class="row" style="margin-bottom:20px; border-bottom: 0.5px solid; border-color:lightgray;">
        	 <div class="col">
	     		<img src="../../../../resources/img/logo/shinhanCard_logo.png" style="width:50px; float:left; padding-right:10px;">
	       		...
	       		<br>
	       		<lable>사용금액</lable>
	       		<input type="text" value="12,300원" style="border-style: none; width:300px; background: none;">
            </div>
        </div>
       <div class="row" style="margin-bottom:20px; border-bottom: 0.5px solid; border-color:lightgray;">
        	 <div class="col">
	       		...
	       		<br>
	       		<lable>사용금액</lable>
	       		<input type="text" value="1,212,310원" style="border-style: none; width:300px; background: none;">
            </div>
        </div>
        <div class="row" style="margin-bottom:20px; border-bottom: 0.5px solid; border-color:lightgray;">
        	 <div class="col">
	       		...
	       		<br>
	       		<lable>사용금액</lable>
	       		<input type="text" value="200,010원" style="border-style: none; width:300px; background: none;">
            </div>
        </div>
       <div class="row" style="margin-bottom:20px; border-bottom: 0.5px solid; border-color:lightgray;">
        	 <div class="col">
	       		...
	       		<br>
	       		<lable>사용금액</lable>
	       		<input type="text" value="50,000원" style="border-style: none; width:300px; background: none;">
            </div>
        </div>
    </div>
